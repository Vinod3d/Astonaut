  ...
  return (
    <div className="px-8 pb-10">
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="flex flex-col justify-center items-center gap-8 h-66 bg-gradient-to-r from-purple-600 to-purple-800 p-6 rounded-2xl shadow-lg text-center">
        ...
        <div className="w-full relative flex flex-col justify-center items-center gap-8 h-66 bg-gradient-to-r border p-6 rounded-2xl shadow-lg text-center overflow-hidden">
